...
describe('Create EPUB with invalid document metadata (epubVersion 3)', () => {
  ...
  it('should throw an exception if epubVersion is invalid', () => {
    expect(() => {
      nodepub.document({
        id: '1', title: 'T', author: 'A', cover: 'cover.png', epubVersion: 4
      })
    }).to.throw(': epubVersion')
  })
})
