...
describe("Create EPUB with invalid document metadata", function () {
  ...
  it("should throw an exception if no Cover", function () {
    expect(function () {
      nodepub.document({ id: "1", title: "T", author: "A", genre: 'Non-Fiction' })
    }).to.throw("cover");
  });
  ...
  it("should throw an exception if a missing Cover is specified", function () {
    expect(function () {
      nodepub.document({ id: "1", title: "T", author: "A", genre: 'Non-Fiction' }, undefined)
    }).to.throw("cover");
  });
